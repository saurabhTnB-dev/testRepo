...
addVariable(UA_Server* server) {
    ...
    attr.description = UA_LOCALIZEDTEXT(const_cast<char *>("en-US"), const_cast < char*>("the answer"));
    attr.displayName = UA_LOCALIZEDTEXT(const_cast<char*>("en-US"), const_cast<char*>("the answer"));
...
addMatrixVariable(UA_Server* server) {
    UA_VariableAttributes attr = UA_VariableAttributes_default;
    attr.displayName = UA_LOCALIZEDTEXT(const_cast<char*>("en-US"), const_cast < char*>("Double Matrix"));
    attr.accessLevel = UA_ACCESSLEVELMASK_READ | UA_ACCESSLEVELMASK_WRITE;
    ...
    UA_NodeId myIntegerNodeId = UA_NODEID_STRING(1, const_cast<char*>("double.matrix"));
    UA_QualifiedName myIntegerName = UA_QUALIFIEDNAME(1, const_cast<char*>("double matrix"));
    UA_NodeId parentNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER);
    UA_NodeId parentReferenceNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES);
    UA_Server_addVariableNode(server, myIntegerNodeId, parentNodeId,
        parentReferenceNodeId, myIntegerName,
...
writeWrongVariable(UA_Server* server) {
    ...
    /* Write a string */
    UA_String myString = UA_STRING(const_cast<char*>("test"));
    UA_Variant myVar;
    UA_Variant_init(&myVar);
...
int main(void) {
	...
	printf("Saurabh Cognizant:Change 0708:2040");
